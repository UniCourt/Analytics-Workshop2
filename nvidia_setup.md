...
![NVIDIA AI sign-in modal](images/nvidia_signin.png)
...
![NVIDIA create account form](images/nvidia_create_account.png)

![NVIDIA verify email OTP](images/nvidia_verify_email.png)
...
![NVIDIA registration recommendation settings](images/nvidia_almost_done.png)
...
![NVIDIA Cloud Account creation](images/nvidia_cloud_account.png)
...
![NVIDIA phone number verification](images/nvidia_verify_phone.png)
...
![NVIDIA Help Center Get API Key](images/nvidia_get_api_key.png)
...
![NVIDIA API Key Granted](images/nvidia_api_key_granted.png)
